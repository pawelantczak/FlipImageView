...
public class SampleActivity extends Activity implements
		FlipImageView.OnFlipListener, SeekBar.OnSeekBarChangeListener {

	private static final String[] fData = new String[] { "Decelerate",
			"Accelerate", "AccelerateDecelerate", "Bounce", "Overshoot",
			"AnticipateOvershoot"
	...
	private static final Interpolator[] fInterpolators = new Interpolator[] {
			...
			new OvershootInterpolator(), new AnticipateOvershootInterpolator() };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mSpinner.setAdapter(new ArrayAdapter<String>(this,
				android.R.layout.simple_dropdown_item_1line, fData));
	...
	public void onClick(FlipImageView view) {
		mFlipImageView.setInterpolator(fInterpolators[mSpinner
